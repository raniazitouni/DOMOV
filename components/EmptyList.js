...
export default function EmptyList({handleClick}) {
    ...
    const navigateToSmartSwitchScreen = () => {
...
return (
    <View style={tw `flex justify-center items-center mt-20`}>
      ...
      <TouchableOpacity   onPress={navigateToSmartSwitchScreen} style={[tw `flex justify-center items-center m-2 h-10 w-[150px] rounded-3 shadow-lg  `,
